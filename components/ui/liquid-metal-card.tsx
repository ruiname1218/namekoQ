  ...
  return (
    <Card
      ...
      <LiquidMetal
        ...
        offsetY={offsetY}
      />
      <div className='pointer-events-none absolute inset-0.75 rounded-[6px] bg-card inset-shadow-lg' />
      <div className='relative z-10 flex flex-col gap-6 group-data-[size=sm]/card:gap-4'>
        {children}
      </div>
    </Card>
  );
